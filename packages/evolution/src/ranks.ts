...
export const RANKS: readonly RankDef[] = [
  ...
  },
  {
    ...
    nome: 'Buggy #9',
    nomeLivre: 'Gaiola 9',
    leitura: 'Nada além do necessário. Pontua acima da mediana da coorte e virou referência.',
    mediaMin: 4.0,
    pisoMin: 3,
    competicao: 'mediana',
  ...
  },
  {
    ...
    nomeLivre: 'Enxame',
    leitura:
      'Sem carro e com pouco registro, mas com gente e vontade. É ponto de partida, não castigo.',
    mediaMin: 0,
    pisoMin: 0,
    competicao: null,
