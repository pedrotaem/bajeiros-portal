...
| C6 | ARQ-A4 | Corpus como documento *custom content* (1 bloco por seção); mapeamento índice de citação→`sectionId`+página; sem depender de `page_location` |
