  ...
  return (
    <div className="bj-page bj-prosa">
      <p className="bj-lead">
        ...
        equipe Baja, para quem participa. O centro do portal é a evolução das equipes, e cada
        ferramenta existe para produzir evidência dessa evolução.
      </p>
      ...
      <section className="bj-aviso">
        ...
        <ul>
          <li>
            Ferramenta <b>educacional</b> de apoio ao projeto. Ela <b>não substitui</b> a Inspeção
          ...
          <li>
            As verificações são paráfrases interpretativas do regulamento. O texto oficial do RATBSB
            (emenda 7) prevalece sempre.
          </li>
          <li>
      ...
      <section>
        ...
        <ul className="bj-lista">
          <li>
            <b>Evolução da equipe</b>: maturidade por área, com critérios verificáveis e uma fila de
            próximos passos com dono.
          </li>
          <li>
            <b>Conhecimento</b>: diário de decisões, guias com dono e kits de passagem, contra o
            problema nº 1 das equipes, que é a rotatividade.
          </li>
          <li>
          ...
          <li>
            <b>Assistente do regulamento</b>: você pergunta em português e recebe a resposta com a
            seção e a página citadas.
          </li>
          <li>
