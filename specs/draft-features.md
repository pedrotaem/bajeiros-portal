...
**Em aberto no backlog:** nada de lote novo. As pendências são residuais e estão nomeadas
dentro de cada draft — DF-4 v2 (3D), AC-DF7.2 (validação física), ondas 2+ da aferição do
DF-20, N2 do DF-27, vista Mês do DF-33, espelho do PDF em bucket próprio no DF-34 (§13.1).
...
| 15 ✅  | [DF-34](drafts/df34-regulamento-leitor.md)         | Regulamento: índice, leitura e ponte — **implementada**  | DF-33, DF-8, DF-12 | A citação do assistente deixa de ser texto e vira porta: seção, página e o documento aberto nela |
...
- **[DF-34](drafts/df34-regulamento-leitor.md)** — o índice do regulamento (1 360 blocos, só
  ...
  entrega todo o resto sem reproduzir uma linha do texto. **Implementado**, e com a leitura
  dentro do portal: como a organização distribui o PDF em download aberto, o portal serve uma
  cópia inalterada com a data e a hora do download e o hash conferido
