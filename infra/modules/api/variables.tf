...
# DF-28: `assistant_anon_daily` foi REMOVIDA — o assistente passou a exigir conta em
# todo ambiente, o que é mais fechado que o `0` que a cortina do DF-27 usava aqui.
